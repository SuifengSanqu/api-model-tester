...
### 1. 国内无需魔法 (Render 部署)
👉 **[https://api-model-tester.onrender.com/](https://api-model-tester.onrender.com/)**
> ⚠️ **注意**：若长时间无人使用，第一次冷启动约需 5 秒。

### 2. 需要魔法 (Cloudflare Workers 部署)
👉 **[https://api-model-tester.wu806634053-84b.workers.dev/](https://api-model-tester.wu806634053-84b.workers.dev/)**
